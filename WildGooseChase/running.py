...
frame_0 = pygame.image.load('sprites/goose_run0.png')
frame_1 = pygame.image.load('sprites/goose_run1.png')
frame_2 = pygame.image.load('sprites/goose_run2.png')
frame_3 = pygame.image.load('sprites/goose_run3.png')
frame_4 = pygame.image.load('sprites/goose_run4.png')
frame_5 = pygame.image.load('sprites/goose_run5.png')
frame_6 = pygame.image.load('sprites/goose_run6.png')
frame_7 = pygame.image.load('sprites/goose_run7.png')

img_wdth = frame_0.get_width()
img_hght = frame_0.get_height()

# img_wdth = 50
# img_hght = 50
# duck = pygame.image.load('sprites/duck.jpg')
...
#     rectangle = pygame.Rect(50,50,50,50)
    ...
    screen.blit(frame_0, (image_x + camera_offset_x, image_y))
    screen.blit(frame_1, (image_x + camera_offset_x, image_y))
    screen.blit(frame_2, (image_x + camera_offset_x, image_y))
    screen.blit(frame_3, (image_x + camera_offset_x, image_y))
    screen.blit(frame_4, (image_x + camera_offset_x, image_y))
    screen.blit(frame_5, (image_x + camera_offset_x, image_y))
    screen.blit(frame_6, (image_x + camera_offset_x, image_y))
    screen.blit(frame_7, (image_x + camera_offset_x, image_y))

    duck_rect = frame_0.get_rect().move(image_x + camera_offset_x, image_y)
